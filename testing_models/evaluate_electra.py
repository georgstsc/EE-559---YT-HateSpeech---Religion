...
parser = argparse.ArgumentParser(description="Evaluate ELECTRA model on a test dataset")
parser.add_argument('--data_path', type=str, required=True,
                    help="Path to test CSV file (must have 'text' and 'label' columns)")
parser.add_argument('--output_path', type=str, required=True,
                    help="Path to save predictions CSV")
parser.add_argument('--model_path', type=str, default="/home/schwabed/EE-559---YT-HateSpeech---Religion/models/electra-small-hate",
                    help="Path to trained ELECTRA model")
