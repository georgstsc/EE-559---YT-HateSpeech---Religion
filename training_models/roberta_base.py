...
# parser = argparse.ArgumentParser(description="Train RoBERTa model on hate speech dataset")
...
# parser.add_argument('--model_path', type=str, default="/home/schwabed/EE-559---YT-HateSpeech---Religion/models/roberta-base-hate",
#                     help="Path to save trained RoBERTa model")
...
# ---------------- ARGUMENTS ----------------
parser = argparse.ArgumentParser(description="Tune RoBERTa model on hate speech dataset")
...
parser.add_argument('--model_path', type=str, default="../models/roberta_optuna")
parser.add_argument('--epochs', type=int, default=10)
args = parser.parse_args()
